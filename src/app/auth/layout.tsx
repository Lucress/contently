      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-brand-600 to-brand-800 items-center justify-center p-12">
        <div className="max-w-lg text-white">
          ...
          <p className="text-lg text-white/80 mb-8">
            Gérez vos idées, planifiez vos tournages, suivez vos collaborations et analysez vos performances — le tout en un seul endroit.
          </p>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span>Capture d'inspirations rapide</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span>Planification de contenu avancée</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
